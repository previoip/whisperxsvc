...
models = dict()
models['ja'] = whisperx.load_model('base', device, compute_type='int8', language='ja', download_root='./cache')
...
def transcribe(lang, audio):
  ...
  res = models[lang].transcribe(audio, batch_size=batch_size, task='translate')
